...
vim.g.have_nerd_font = true -- [[ Setting options ]]
-- See `:help vim.o`
...
require('lazy').setup({
  ...
  {
    -- Fuzzy Finder replacement for Telescope
    'ibhagwan/fzf-lua',
    event = 'VimEnter',
    dependencies = {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>srr', fzf.resume, { desc = '[S]earch [R]esume' })
      vim.keymap.set('n', '<leader>s.', fzf.oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
      vim.keymap.set('n', '<leader><leader>', fzf.buffers, { desc = '[ ] Find existing buffers' })
      vim.keymap.set('n', '<leader>/', function()
        fzf.fzf_live({ cmd = "rg --column --line-number --no-heading --color=always --smart-case .", prompt = "Rg> " })
  ...
  },
  {
    ...
    dependencies = {
      ...
      { 'mason-org/mason.nvim', opts = { ensure_installed = { 'pyright' } } },
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Add/delete/replace [sthkr(lookup_key)]  # type: ignore[sthkr(lookup_key)]  # type: ignore[sthkr(lookup_key)]  # type: ignoresurroundings (brackets, quotes, etc.)
      --
