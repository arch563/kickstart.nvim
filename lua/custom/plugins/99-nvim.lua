...
util.add { util.gh 'ThePrimeagen/99' }
...
_99.setup {
  ...
  tmp_dir = '~/workspace/monorepo-cv/tmp',
...
vim.keymap.set('v', '<leader>9v', function() _99.visual() end, { desc = '99 visual prompt' })
...
vim.keymap.set('n', '<leader>9m', function() require('99.extensions.fzf_lua').select_model() end, { desc = '99 select model' })
vim.keymap.set('n', '<leader>9ww', function() require('99.extensions.work.worker').set_work() end, { desc = '99 set work' })
vim.keymap.set('n', '<leader>9ws', function() require('99.extensions.work.worker').search() end, { desc = '99 set work' })

vim.keymap.set('n', '<leader>9i', function() _99.info() end, { desc = '99 info' })
vim.keymap.set('n', '<leader>9l', function() _99.view_logs() end, { desc = '99 logs' })
...
vim.keymap.set('n', '<leader>9v', function() _99.vibe() end)